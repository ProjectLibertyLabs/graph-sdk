...
pub struct Config {
    ...
    // @@protoc_insertion_point(field:Config.graph_key_pair_schema_id)
    pub graph_key_pair_schema_id: u32,
...
impl Config {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            ...
            |m: &Config| { &m.graph_key_pair_schema_id },
            |m: &mut Config| { &mut m.graph_key_pair_schema_id },
        ));
...
impl ::protobuf::Message for Config {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                40 => {
                    self.graph_key_pair_schema_id = is.read_uint32()?;
                },
                50 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.graph_key_pair_schema_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.graph_key_pair_schema_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.graph_key_pair_schema_id != 0 {
            os.write_uint32(5, self.graph_key_pair_schema_id)?;
        }
        for (k, v) in &self.schema_map {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::uint32_size(1, *k);
    ...
    fn clear(&mut self) {
        ...
        self.graph_key_pair_schema_id = 0;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ytes\x18\x04\x20\x01(\rR\x13maxKeyPageSizeBytes\x126\n\x18graph_key_pair\
    _schema_id\x18\x05\x20\x01(\rR\x14graphKeyPairSchemaId\x125\n\nschema_ma\
    p\x18\x06\x20\x03(\x0b2\x16.Config.SchemaMapEntryR\tschemaMap\x121\n\rds\
    np_versions\x18\x07\x20\x03(\x0e2\x0c.DsnpVersionR\x0cdsnpVersions\x1aK\
